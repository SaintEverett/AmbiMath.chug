...
//    (the bulid process should yield a AmbiMath.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:AmbiMath.chug AmbiMath-test.ck`
//
...
//    `chuck --chugin:AmbiMath.chug AmbiMath-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a AmbiMath
AmbiMath obj;
